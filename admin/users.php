...
if(isset($_POST['call']) && !empty($_POST['call'])) {
    $function2call = $_POST['call'];
    switch($function2call) {
        case 'update_time_useronline' : update_time_useronline($_POST['data']);break;
        case 'logout_time_useronline' : logout_time_useronline($_POST['data']);break;
        // other cases
    }
}
