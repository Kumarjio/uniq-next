...
box_start();
    ...
    if($report_id == '107'){
    	echo "<button class='btn green' type='button' id='btninvoice' onclick='print_invoice()'>WORD : Display ".access_string($reports->report_current->name, true)."</button>";
	}else if($report_id == '113'){
		echo "<button class='btn green' type='button' id='btncreditnote' onclick='print_creditnote()'>WORD : Display ".access_string($reports->report_current->name, true)."</button>";
	}else if($report_id == '110'){
		echo "<button class='btn green' type='button' id='btndeliverynote' onclick='print_deliverynote()'>WORD : Display ".access_string($reports->report_current->name, true)."</button>";
	}else if($report_id == '109'){
		echo "<button class='btn green' type='button' id='btnsalesorder' onclick='print_salesorder()'>WORD : Display ".access_string($reports->report_current->name, true)."</button>";
	}else if($report_id == '111'){
		echo "<button class='btn green' type='button' id='btnsalesquot' onclick='print_salesquot()'>WORD : Display ".access_string($reports->report_current->name, true)."</button>";
	}else if($report_id == '112'){
		echo "<button class='btn green' type='button' id='btnpayment' onclick='print_payment()'>WORD : Display ".access_string($reports->report_current->name, true)."</button>";
	}else if($report_id == '209'){
		echo "<button class='btn green' type='button' id='btnpurchaseorder' onclick='print_purchaseorder()'>WORD : Display ".access_string($reports->report_current->name, true)."</button>";
	}else if($report_id == '210'){
		echo "<button class='btn green' type='button' id='btnremittance' onclick='print_remittance()'>WORD : Display ".access_string($reports->report_current->name, true)."</button>";
	}
