...
function form_group_bootstrap($label, $input, $columns = '3-9', $help = NULL,$attribute=NULL)
{
    ...
    if (strlen($help) > 0) {
        ...
        $html .= "<div class=\"col-$input_col align-items-center $input_list_fix_mobile \"><span synlang='syncard-language'>$input</span></div>";
        $html .='</div>';
...
function box_footer_show_active($show_back = false)
{
    ...
    echo "<div class='pull-right margin-top'>";
