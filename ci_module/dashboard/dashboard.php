...
class Dashboard
{
    ...
    function home()
    {
        // echo json_encode($db_connections);
        $home = $_SESSION['apidumm'];

        if ($home['SALES']['OPERATIONS'][0]['name'] == "Sales Quotation" && $home['SALES']['OPERATIONS'][0]['active'] == "1"){
            $home_shoft['quote'] = array(
        ...
        if ($home['SALES']['OPERATIONS'][3]['name'] == "Direct Invoice" && $home['SALES']['OPERATIONS'][3]['active'] == "1"){
            $home_shoft['sale-invoice'] = array(
        ...
        if ($home['SALES']['OPERATIONS'][10]['name'] == "Customer Payments" && $home['SALES']['OPERATIONS'][10]['active'] == "1"){
            $home_shoft['customer-payment'] = array(
        ...
        if ($home['SALES']['OPERATIONS'][11]['name'] == "Customer Credit Notes" && $home['SALES']['OPERATIONS'][11]['active'] == "1"){
            $home_shoft['customer-credit'] = array(
        ...
        if ($home['PURCHASE']['OPERATIONS'][42]['name'] == "Payment to Supplies" && $home['PURCHASE']['OPERATIONS'][42]['active'] == "1"){
            $home_shoft['supplier-payment'] = array(
        ...
        if ($home['CASH and GL']['OPERATIONS'][80]['name'] == "Payments" && $home['CASH and GL']['OPERATIONS'][80]['active'] == "1"){
            $home_shoft['bank-payment'] = array(
        ...
        if ($home['CASH and GL']['INQUIRIES'][89]['name'] == "Bank Account" && $home['CASH and GL']['INQUIRIES'][89]['active'] == "1"){
            $home_shoft['bank-trans'] = array(
        ...
        if ($home['SALES']['DOC PRINTING'][26]['name'] == "Print Statements" && $home['SALES']['DOC PRINTING'][26]['active'] == "1"){
            $home_shoft['customer-statement'] = array(
        ...
        if ($home['CASH and GL']['INQUIRIES'][93]['name'] == "Profit & Loss Drilldown" && $home['CASH and GL']['INQUIRIES'][93]['active'] == "1"){
            $home_shoft['profit-loss'] = array(
        ...
        if ($home['CASH and GL']['INQUIRIES'][92]['name'] == "Balance Sheet Drilldown" && $home['CASH and GL']['INQUIRIES'][92]['active'] == "1"){
            $home_shoft['balance-sheet'] = array(
        ...
        if ($home['CASH and GL']['INQUIRIES'][86]['name'] == "GST Form 3 / Form 5" && $home['CASH and GL']['INQUIRIES'][86]['active'] == "1"){
            $home_shoft['gst'] = array(
                    'gst/form-5',
                    'Prepare GST Return',
    ...
    private function customers($graph_type = 'ColumnChart', $title = NULL, $id = 0, $today = null)
    {
        ...
        if ($graph_type == 'Table') {
            ...
            if ($graph_type == 'ColumnChart') {
                ...
                $html .= '<img src="' . COMPANY_ASSETS . '/' . $img_file . '" border="0">';
                $html .= '</div>';
            }
        return $html;
    }
